...
public class ActivityContratoGas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dni = findViewById(R.id.txtDNICLIContratoGas);
        telefono1 = findViewById(R.id.txtTelefono1CLIContratoGas);
        telefono2 = findViewById(R.id.txtTelefono2CLIContratoGas);
        email = findViewById(R.id.txtEmailCLIContratoGas);
        direccion = findViewById(R.id.txtDireccionCLIContratoGas);
        numero= findViewById(R.id.txtNumeroCLIContratoGas);
        piso = findViewById(R.id.txtPisoCLIContratoGas);
        puerta = findViewById(R.id.txtPuertaCLIContratoGas);
        localidad = findViewById(R.id.txtLocalidadCLIContratoGas);
        provincia = findViewById(R.id.txtProvinciaCLIContratoGas);
        cp = findViewById(R.id.txtCPCLIContratoGas);
        representante = findViewById(R.id.txtRepresentanteCLIContratoGas);
        nifRepresentante = findViewById(R.id.txtNIFRepresentanteCLIContratoGas);
        recordar = findViewById(R.id.chkRecordarDatosClienteGas);
        siguiente = findViewById(R.id.btnSiguienteContratoGas1);
        anterior = findViewById(R.id.btnAnteriorContratoGas1);
    ...
    /**
     * Mediante este método permitimos que el usuario pueda ir a la actividad anterior ya sea la de gas como la de contratos
     */
    @Override
