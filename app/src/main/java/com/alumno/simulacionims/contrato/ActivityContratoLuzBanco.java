 ...
 * Objeto con el que mediante la actividad para rellenar campos del Apartado de Banco Contratos Luz
 */
public class ActivityContratoLuzBanco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre = findViewById(R.id.txtNombreBANContrato);
        iban = findViewById(R.id.txtIBANBANContrato);
        recordar = findViewById(R.id.chkRecordarDatosBancoLuz);
        anterior = findViewById(R.id.btnAnteriorContratoLuz5);
        contrat = findViewById(R.id.btnCreaContratoFinalLuz);
